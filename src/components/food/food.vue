  ...
  <div class="food" v-show="showFlag" ref="food">
    <div class="food-content">
      ...
      <div class="content">
        ...
        <div class="price">
           <span class="now" v-show="food.price">￥{{food.price}}</span><span class="old" v-show="food.oldPrice">￥{{food.oldPrice}}</span>
        </div>
        <div class="cartcontrol-wrapper" v-show="food.count&&food.count !== 0" >
          <cartcontrol :food="food" ref="cartcontrol" @cartadd="_clickdrop"></cartcontrol>
        </div>
      ...
      <div class="rating">
        ...
        <ratingselect @selected="change" :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
